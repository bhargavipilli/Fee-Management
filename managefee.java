            ...
            public void actionPerformed(ActionEvent e) {
                ...
                b51.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e)
                    {
                                ...
                                t62.setBounds(150,125,150,30);
                                JTextField t64=new JTextField();
                                t63.setBounds(150,175,150,30);         
                                    ...
                                    public void actionPerformed(ActionEvent e)
                                    {
                                        ...
                                        && t66.getText().trim().length()>0 && t67.getText().trim().length()>0  && t68.getText().trim().length()>0  && t611.getText().trim().length()>0 && t612.getText().trim().length()>0)
                                            ...
                                            try{
                                                    ...
                                                    PreparedStatement pstmt=con.prepareStatement(Qry);
                                                    pstmt.setString(1,t61.getText() );
                                                    pstmt.setString(2,t62.getText() );
                                                    pstmt.setString(3,t63.getText());          
                                                    pstmt.setString(4,t64.getText());
                                                    pstmt.setString(5,t65.getText());
                                                    pstmt.setString(6,t66.getText());
                                                    pstmt.setString(7,t67.getText());
                                                    pstmt.setString(8,t68.getText());
                                                    pstmt.setString(9,t69.getText());
                                                    pstmt.setString(10,t610.getText());
                                                    pstmt.setString(11,t611.getText());
                                                    pstmt.setString(12,t612.getText());
                                                    pstmt.execute();
